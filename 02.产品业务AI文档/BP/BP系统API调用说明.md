...
**配套文档**：[《BP 目标管理 Open API 接口定义》](./BP系统API说明.md)（数据模型 **一、1.4**、**二、2.1～2.33** 接口契约、**三、3.x** 公共类型、**四、错误码**）。
...
> **关于小节号**：版本 **1.10 及以前**的变更摘要若仍写「5.x」「第六章」或「3.x/4.x 接口与类型」，指当时**单文件**或旧版双文档编号；与当前《接口定义》对照时，接口为 **二、2.1～2.33**，公共类型为 **三、3.1～3.20**，字段规格为 **一、1.4.x**。
...
4. **《接口定义》二、2.1～2.34**：具体方法的参数表、示例与 `data` 类型声明。
